          ...
          <ImageBackground
            ...
            <Block flex style={styles.profileDetails}>
              <Block style={styles.profileTexts}>
                <Text color="white" size={28} style={{ paddingBottom: 8 }}>Valeria López</Text>
                <Block row space="between">
                  <Block row>
                    <Block middle style={styles.pro}>
                      <Text size={16} color="white">Pro</Text>
                    </Block>
                    <Text color="white" size={16} muted style={styles.level}>level</Text>
        ...
        <Block flex style={styles.options}>
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <Block row space="between" style={{ paddingVertical: 16, alignItems: 'baseline' }}>
              ...
              <Text size={12} color={theme.COLORS.PRIMARY} onPress={() => this.props.navigation.navigate('Cursos')}>View All</Text>
            </Block>
